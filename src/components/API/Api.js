    ...
    return (
        <div className="row">
            <div className="col-12">
                ...
                <p>Atgriež slāņu sarakstu par noteikto periodu.</p>
                <ul>
                    <li>
                        <i>
                            Pieprasījuma metode: <b>GET</b>
                        </i>
                    </li>
                    <li>
                        <i>URL parametri</i>:
                        <ul>
                            <li>
                                <b>from</b> (vesels skaitlis) - minimālais slāņa
                                izveidošanas datums <i>UNIX timestamp</i>{" "}
                                formatā;
                            </li>
                            <li>
                                <b>to</b> (vesels skaitlis) - maksimālais slāņa
                                izveidošanas datums <i>UNIX timestamp</i>{" "}
                                formatā.
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <b>
                            <a href="https://www.tea-spill-keyboard.id.lv/api/get/period?from=1635322507&to=1635326107">
                                /api/get/period?from=1635322507&to=1635326107
                            </a>
                        </b>
                    </li>
                </ul>
